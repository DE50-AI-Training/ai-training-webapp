...
const Datasets = () => {
return ( //shadow-lg border border-gray-200
    <div className="flex w-full flex-col bg-white mt-10 rounded-lg ring-2 ring-gray-200 p-20 pt-6 pb-6">
        <div className="pb-10">
            <p className="text-center text-[35px] font-bold">Training Data</p>
        </div>
        <div className="flex justify-between items-center flex-col sm:flex-row mb-3">
            ...
            <div className="flex gap-4 items-center flex-col sm:flex-row">
                <Button className="w-[120px] bg-gray-200 border border-black text-black">Manage</Button>
                <Button className="w-[120px] bg-gradient-to-br from-green-100 to-orange-100 text-black border border-black">New data +</Button>
            </div>
        </div>
